...
const PACKAGES = [
  {
    ...
    price: "29 000 ₽",
    period: "/ месяц",
    desc: "Идеально, чтобы попробовать формат",
    features: [
      "Логотип на стойке и в меню",
      "Упоминание в Telegram-канале (2 раза)",
      "Стопка ваших визиток на кассе",
      "Отчёт по охватам в конце месяца",
    ],
    accent: false,
  },
  {
    ...
    price: "65 000 ₽",
    period: "/ месяц",
    desc: "Хочется по-серьёзному",
    features: [
      "Всё из тарифа «Старт»",
      "Брендированный стакан или тейк-эвей",
      "Совместная акция с вашим продуктом",
      "Сторис и Reels на нашем канале",
      "Один тематический ивент",
    ],
    accent: true,
    badge: "Чаще берут",
  },
  {
    ...
    price: "договорная",
    period: "",
    desc: "Полноценная коллаборация",
    features: [
      "Совместная позиция в меню",
      "Запуск ко-брендингового напитка/выпечки",
      "PR-кампания и публикации в СМИ",
      "Эксклюзивные ивенты в кофейне",
...
const STEPS = [
  { num: "01", title: "Знакомимся", desc: "Созваниваемся на 20 минут, рассказываем друг другу о себе и проектах." },
  { num: "02", title: "Подбираем формат", desc: "Выбираем подходящий пакет или собираем индивидуальный." },
  { num: "03", title: "Запускаем", desc: "Делаем макеты, согласовываем, выходим в офлайн и онлайн." },
  { num: "04", title: "Растём вместе", desc: "Считаем результат, делимся фидбеком, планируем следующий шаг." },
];
    ...
    <div className="min-h-screen bg-[#FBF6EE] text-[#1a1410] font-body">
      ...
      <section id="hero" className="relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-5 md:px-8 pt-14 md:pt-24 pb-16 md:pb-28 relative">
          ...
          <FadeIn>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white shadow-sm border border-black/5 mb-8">
              <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
              <span className="text-xs font-semibold text-black/60">Сегодня открыто с 8:00 до 22:00</span>
            </div>
          </FadeIn>
        ...
        <div className="max-w-6xl mx-auto relative">
          <FadeIn>
            ...
            <p className="text-white/55 text-base md:text-lg max-w-2xl leading-relaxed mb-12">
              У нас есть аудитория, которая нам доверяет. Если ваш продукт ей подойдёт —
              поможем рассказать о нём так, чтобы это не выглядело как реклама.
            </p>
          </FadeIn>
