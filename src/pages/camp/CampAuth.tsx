    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4 font-body">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={submit} className="space-y-3">
          ...
          {mode === "register" && (
            <label className="flex items-start gap-2.5 text-[12px] text-black/55 leading-snug cursor-pointer px-1">
              <input
                type="checkbox"
                checked={consent}
              ...
              <span>
                ...
                <Link to="/privacy" target="_blank" className="underline hover:text-black/80">Политике конфиденциальности</Link>
                {" "}и принимаю условия{" "}
